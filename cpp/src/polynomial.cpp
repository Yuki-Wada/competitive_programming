...
public:
	Polynomial() : coefs_(1) {}
	Polynomial(ull degree) : coefs_(degree + 1) {}
	Polynomial(ull degree, Coefficient v) : coefs_(degree + 1, v) {}

	string indeterminate_representation = "T";
...
template<class Coefficient> inline Polynomial<Coefficient> operator+(const Polynomial<Coefficient>& lhs, const Polynomial<Coefficient>& rhs){
	...
	Polynomial<Coefficient> poly(degree);
...
// template<class Coefficient> inline Polynomial<Coefficient> operator*(const Polynomial<Coefficient>& lhs, const Coefficient& rhs) {
// 	Polynomial<Coefficient> poly(lhs.get_degree());
// 	for (ll i = 0; i < lhs.get_degree(); ++i) poly(i) += lhs(i) * rhs;
// 	return poly;
// }
// template<class Coefficient> inline Polynomial<Coefficient> operator*(const Coefficient& lhs, const Polynomial<Coefficient>& rhs) {
// 	Polynomial<Coefficient> poly(rhs.get_degree());
// 	for (ll i = 0; i < rhs.get_degree(); ++i) poly(i) += lhs * rhs(i);
// 	return poly;
// }
template<class Coefficient> inline Polynomial<Coefficient>& operator*=(Polynomial<Coefficient>& lhs, const Polynomial<Coefficient>& rhs) {
	ll lhs_degree = lhs.get_degree(), rhs_degree = rhs.get_degree();
...
// template<class Coefficient> inline Polynomial<Coefficient>& operator*=(Polynomial<Coefficient>& lhs, const Coefficient& rhs) {
// 	lhs.a_ = lhs.a() * rhs;
