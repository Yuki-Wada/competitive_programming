...
int solve()
{
	...
	rll a = rll(1) - rll(N - 1LL) * rll(2LL) / rll(N) / rll(N);
	rll b = rll(2LL) / rll(N) / rll(N);
	rll c = rll(N - 1LL) * rll(2LL) / rll(N) / rll(N);
	rll d = rll(1) - rll(2LL) / rll(N) / rll(N);
	...
	rll res = rll(1) * p + (rll(N + 1LL) * rll(N) / rll(2) - rll(1)) * q / rll(N - 1);
